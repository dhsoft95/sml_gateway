...
<head>
    ...
    <title>Merchant Registration | Payment Gateway</title>
    ...
    <div class="max-w-2xl w-full">
        <div class="bg-gray-800 rounded-lg shadow-2xl overflow-hidden border border-gray-700">
            <div class="px-6 py-4 bg-gradient-to-r from-gray-800 to-gray-900 border-b border-gray-700">
                ...
                <p class="mt-1 text-gray-400 text-center text-sm">Create your merchant account</p>
            </div>

            <div class="p-6">
                @if ($errors->any())
                    <div class="rounded-md bg-red-900 p-3 mb-6">
                        <div class="flex">
                ...
                <form class="space-y-6" action="{{ route('merchant.register') }}" method="POST">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                       class="mt-1 block w-full h-10 px-3 py-2 rounded-md border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:border-yellow-500 focus:ring-yellow-500">
                            </div>
                            <div>
                    ...
                    <div class="space-y-4 pt-4">
                        ...
                        <div>
                            <label for="business_name" class="text-sm font-medium text-gray-300">Business Name</label>
                            <input type="text" name="business_name" id="business_name" value="{{ old('business_name') }}" required
                                   class="mt-1 block w-full h-10 px-3 py-2 rounded-md border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:border-yellow-500 focus:ring-yellow-500">
                        </div>
                        <div>
                            <label for="notification_email" class="text-sm font-medium text-gray-300">Notification Email</label>
                            <input type="email" name="notification_email" id="notification_email" value="{{ old('notification_email') }}" required
                                   class="mt-1 block w-full h-10 px-3 py-2 rounded-md border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:border-yellow-500 focus:ring-yellow-500">
                            <p class="mt-1 text-sm text-gray-400">Where you'll receive payment notifications</p>
                        </div>
                        <div>
                            <label for="callback_url" class="text-sm font-medium text-gray-300">Callback URL (Optional)</label>
                            <input type="url" name="callback_url" id="callback_url" value="{{ old('callback_url') }}"
                                   class="mt-1 block w-full h-10 px-3 py-2 rounded-md border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:border-yellow-500 focus:ring-yellow-500"
                                   placeholder="https://yourdomain.com/webhook">
                            <p class="mt-1 text-sm text-gray-400">URL for receiving payment notifications</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 pt-4">
                        ...
                        <button type="submit"
                                class="w-full px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-gray-900 bg-yellow-500 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500">
                            Create Account
                        </button>
                    </div>
                </form>
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-400">
                ...
                <a href="{{ route('merchant.login') }}" class="font-medium text-yellow-500 hover:text-yellow-400">
                    Sign in here
                </a>
            </p>
        </div>
